...
function checkForCanvasError() {
    try {
        require('assetgraph-builder/node_modules/histogram');
    } catch (e) {
        var os = require('os');
        var EOL = os.EOL;
        var command = 'Run: _';
        var platformCommand = '';
        var then = 'npm install -f assetgraph-builder';
...
WebappGenerator.prototype.html5bp = function projectfiles() {
...
WebappGenerator.prototype.writeIndex = function writeIndex() {
